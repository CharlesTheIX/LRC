...
pub const FeedingForm = struct {
    ...
    pub fn deinit(self: *FeedingForm) void {
    ...
    pub fn draw(self: *FeedingForm) void {
    ...
    pub fn init(props: Props) FeedingForm {
    ...
    fn submit(self: *FeedingForm) void {
    ...
    pub fn update(self: *FeedingForm) void {
